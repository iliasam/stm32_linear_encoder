...
const uint8_t conv_table[13]={SYMB_0,SYMB_1,SYMB_2,SYMB_3,SYMB_4,SYMB_5,SYMB_6,SYMB_7,SYMB_8,SYMB_9,SYMB_EMPTY,SYMB_MINUS,SYMB_U};
...
void number_to_string(int32_t number)
{
  memset(&string,0,8);
  sprintf((char*)&string,"%ldu\n",number);
}
